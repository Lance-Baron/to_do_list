pub mod task {
    ...
    pub fn make_task_full(name: String,description:String, source:TaskSource, topic:String, due_date: Date) -> Task {
        Task {
            name,
            description,
            source,
    ...
    mod tests {
        ...
        fn test_make_task_default() {
            ...
            assert_eq!(task1.source, TaskSource::Unknown, "Sources does not match");
        ...
        fn test_make_task_full() {
            ...
            let task1 = make_task_full(String::from("Do HW2"), String::from("Finish up the filters problems from Chapter 11.5"), TaskSource::Canvas,String::from("ECE202"),date);
            ...
            assert_eq!(task1.source, TaskSource::Canvas, "Sources does not match");
